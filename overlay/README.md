...
the upstream DINish source, targeting DINsical values.
...
1. **Comma/period separation** — DINsical doesn't kern before commas; `\comma`
...
4. **Y kern group** — a complete Y-first kern group is added (`@kc6_first_12`).
   Upstream DINish has no Y kern pairs; DINsical has ~28.
...
6. **Extra rule removal** — L/T/F/V/W/K + straight-LC extras removed (DINsical
