...
def interpolate_font(src1, src2, dest, weight):
    ...
    #
    # Anchors were measured by comparing I-glyph stem widths between DIN Whim
    # and Dinsical across the full weight range:
    #   weight 4 (Regular, wght 400)  →  factor 0.298  (stem ≈89,  DIN Whim Regular=89)
    #   weight 5 (Medium,  wght 500)  →  factor 0.807  (stem ≈118, DIN Whim Medium=118)
    #   weight 7 (Bold,    wght 700)  →  factor 1.316  (stem ≈148, DIN Whim Bold=147)
    # Note: DIN Whim Bold ≈ Dinsical Heavy in stem weight.
